...
<!-- HashData: Titres de cellules -->
<%@ include file="hashData.jsp" %>
<!DOCTYPE html >
<html>
<head>
<meta charset="utf-8">
<link type="text/css" rel="stylesheet" href="monStyle4.css"/>
<header class="div0">
...
<tr>
<td><label>Date:</label><label class="date"><c:out value="${model2.updateDate}" default=""/></label></td>
</tr>
<tr>
...
<tr>
<td><label>Text:</label><input type="text"  name="textTag" maxlength="30"/></td>
</tr>
<tr>
<td><label>Message :</label><label class="message">${model2.message} </label></td>
</tr>
<tr>
<td><button type="submit" value="SEND" name="actionTag">SEND</button></td>
</tr>
</table>
</form>
</header>
